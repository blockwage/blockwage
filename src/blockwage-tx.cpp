...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Blockwage Core blockwage-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  blockwage-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blockwage transaction") + "\n" +
                               "  blockwage-tx [options] -create [commands]   " + _("Create hex-encoded blockwage transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded blockwage transaction
