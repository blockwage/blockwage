                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Blockwage from zBWG"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBWG"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBWG));
