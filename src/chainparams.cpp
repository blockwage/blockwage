...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000008f271bcee1348fc130713872708401f39f734cc92dd5c1dd6a8d2a11348"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1553341733, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("049a51f9f267a10b2c4ce48eddd9eb640367fbfadec2fece1dc4f3873cfa6fe823b4f73448242ccc2cb7c51f1c58c192f19f190560da754ac0758cf04ad33e7429");
        nDefaultPort = 14411;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 Blockwage starting difficulty is 1 / 2^12
        ...
        const char* pszTimestamp = "Our greatest weakness lies in giving up. The most certain way to succeed is always to try just one more time.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04a653f110d4b2166b7d1e7de015d21d63c7da3ea1a15d05894adb19321588495aa60f2bed8057fd3c2a83cd2c10890c132572ec6ddf29038a3317e04115d5f887") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1553341733;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 650753;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000008f271bcee1348fc130713872708401f39f734cc92dd5c1dd6a8d2a11348"));
        assert(genesis.hashMerkleRoot == uint256("0x31fc8d6f310bbc7342701bee0e2df5052399390a9639821606bedaa8a834743a"));

	vSeeds.push_back(CDNSSeedData("95.179.190.87", "95.179.190.87"));
        vSeeds.push_back(CDNSSeedData("155.138.144.228", "155.138.144.228"));
        vSeeds.push_back(CDNSSeedData("155.138.137.35", "155.138.137.35"));
	...
	strSporkKey = "0491BC7A9CBC810A0BC3180A273A6BD405EBBF6042A12D9901C18B8FA9C177D556FD560D6E3BF7711188673A1458B418567CDF3663A21A9E4F7AC54B042982A93F";
        strObfuscationPoolDummyAddress = "BE7mrVmmuKv35JDgGJMR2xLxYdqQsx7ocX";
        nStartMasternodePayments = 1553341733;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Blockwage: 1 day
        nTargetSpacing = 1 * 60;  // Blockwage: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet blockwage addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet blockwage script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet blockwage BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet blockwage BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet blockwage BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Blockwage: 1 day
        nTargetSpacing = 1 * 60;        // Blockwage: 1 minutes
