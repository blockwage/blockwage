...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Blockwage Core"),
     ...
     * override -datadir in the blockwage.conf file in the default data directory
     * (to be consistent with blockwaged behavior)
     */
    if (dataDir != getDefaultDataDirectory())
