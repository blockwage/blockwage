...
/** Utility functions used by the Blockwage Qt UI.
 */
namespace GUIUtil
{
...
// Render Blockwage addresses in monospace font
...
// Parse "blockwage:" URI into recipient object, return true on successful parsing
