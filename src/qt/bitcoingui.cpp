                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Blockwage-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Blockwage address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blockwage: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Blockwage Core"), this);
    aboutAction->setStatusTip(tr("Show information about Blockwage Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Blockwage"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Blockwage addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Blockwage addresses"));
    ...
    openAction->setStatusTip(tr("Open a Blockwage: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Blockwage Core help message to get a list with possible Blockwage command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Blockwage Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Blockwage network", "", count));
}
...
{
    QString strTitle = tr("Blockwage Core"); // default title
