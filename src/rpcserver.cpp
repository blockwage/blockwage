...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Blockwage server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Blockwage server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Blockwage features */
        {"blockwage", "masternode", &masternode, true, true, false},
        {"blockwage", "listmasternodes", &listmasternodes, true, true, false},
        {"blockwage", "getmasternodecount", &getmasternodecount, true, true, false},
        {"blockwage", "masternodeconnect", &masternodeconnect, true, true, false},
        {"blockwage", "masternodecurrent", &masternodecurrent, true, true, false},
        {"blockwage", "masternodedebug", &masternodedebug, true, true, false},
        {"blockwage", "startmasternode", &startmasternode, true, true, false},
        {"blockwage", "createmasternodekey", &createmasternodekey, true, true, false},
        {"blockwage", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"blockwage", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"blockwage", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"blockwage", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"blockwage", "getmasternodescores", &getmasternodescores, true, true, false},
        {"blockwage", "mnbudget", &mnbudget, true, true, false},
        {"blockwage", "preparebudget", &preparebudget, true, true, false},
        {"blockwage", "submitbudget", &submitbudget, true, true, false},
        {"blockwage", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"blockwage", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"blockwage", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"blockwage", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"blockwage", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"blockwage", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"blockwage", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blockwage", "checkbudgets", &checkbudgets, true, true, false},
        {"blockwage", "mnsync", &mnsync, true, true, false},
        {"blockwage", "spork", &spork, true, true, false},
        {"blockwage", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"blockwage", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use blockwaged, or the -server option to blockwage-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> blockwage-cli " + methodname + " " + args + "\n";
}
