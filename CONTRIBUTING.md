Contributing to Blockwage Core
============================

The Blockwage Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Blockwage Core project, and is not to be
confused with overall Blockwage Network Protocol consensus changes.

Whether a pull request is merged into Blockwage Core rests with the project merge
...
Patches that change Blockwage consensus rules are considerably more involved than
...
Where a patch set proposes to change the Blockwage consensus, it must have been
...
The project leader is the release manager for each Blockwage Core release.
