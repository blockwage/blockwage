...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/blockwage-cli.cpp \
           src/blockwage-tx.cpp \
           src/blockwage.cpp \
           src/db.cpp \
           ...
           src/qt/blockwage.cpp \
           src/qt/blockwagestrings.cpp \
...
RESOURCES += src/qt/blockwage.qrc src/qt/blockwage_locale.qrc

TRANSLATIONS += src/qt/locale/blockwage_bg.ts \
                src/qt/locale/blockwage_de.ts \
                src/qt/locale/blockwage_en.ts \
                src/qt/locale/blockwage_es.ts \
                src/qt/locale/blockwage_fi.ts \
                src/qt/locale/blockwage_fr.ts \
                src/qt/locale/blockwage_it.ts \
                src/qt/locale/blockwage_ja.ts \
                src/qt/locale/blockwage_pl.ts \
                src/qt/locale/blockwage_pt.ts \
                src/qt/locale/blockwage_ru.ts \
                src/qt/locale/blockwage_sk.ts \
                src/qt/locale/blockwage_sv.ts \
                src/qt/locale/blockwage_vi.ts \
                src/qt/locale/blockwage_zh_CN.ts \
                src/qt/locale/blockwage_zh_TW.ts
